package uk.gov.hmrc.timeoutdialogdemo.controllers
...
import uk.gov.hmrc.timeoutdialogdemo.config.AppConfig
import uk.gov.hmrc.timeoutdialogdemo.views.html.HelloWorldPage
